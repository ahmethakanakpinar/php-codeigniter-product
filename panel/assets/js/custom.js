$(document).ready(function(){
    ...
    //     if (!isNaN(inputValue)) {
    //       // Geçerli bir sayı girişi, devam edebilirsiniz.
    //       alert('Sayı girişi kabul edildi: ' + value);
    //     } else {
    //       // Sayı girişi değil, boş hale getirin veya hata mesajı gösterin.
    //       input.value = '';
    //       alert('Hatalı giriş: ' + value);
    //     }
    // })
